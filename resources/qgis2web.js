...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ZONES POTENTIELLES DE DEPART ET DE DESTINATION DE MIGRANTS INTERNES DU BURKINA FASO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (472 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette application permet de vusialiser la dynamique de la migration interne du Burkina Faso en foction de l\'évolution des facteurs déterminants. En quelques clics, on verra les zones d\'importance de départ de migrants et les zones d\'imporance de destination de migrants. Cela permet aux décideurs de prendre des mésures pour réduire ces flux migratoires afin d\'éviter les conséquences tels que les conflits, la destruction de l\'environnement liés à l\'arrivée des migrants.';
            }
